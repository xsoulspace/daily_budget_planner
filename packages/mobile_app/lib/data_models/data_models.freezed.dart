...
@JsonKey(fromJson: localeFromString, toJson: localeToString) Locale? get locale;@JsonKey(fromJson: UiBrightness.fromJson, toJson: UiBrightness.toJson) UiBrightness get brightness; bool get use24HourFormat;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is AppSettingsModel&&(identical(other.locale, locale) || other.locale == locale)&&(identical(other.brightness, brightness) || other.brightness == brightness)&&(identical(other.use24HourFormat, use24HourFormat) || other.use24HourFormat == use24HourFormat));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,locale,brightness,use24HourFormat);
...
@useResult
$Res call({
@JsonKey(fromJson: localeFromString, toJson: localeToString) Locale? locale,@JsonKey(fromJson: UiBrightness.fromJson, toJson: UiBrightness.toJson) UiBrightness brightness, bool use24HourFormat
});
...
/// Create a copy of AppSettingsModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? locale = freezed,Object? brightness = null,Object? use24HourFormat = null,}) {
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@JsonKey(fromJson: localeFromString, toJson: localeToString)  Locale? locale, @JsonKey(fromJson: UiBrightness.fromJson, toJson: UiBrightness.toJson)  UiBrightness brightness,  bool use24HourFormat)  $default,) {final _that = this;
switch (_that) {
case _AppSettingsModel():
return $default(_that.locale,_that.brightness,_that.use24HourFormat);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function(@JsonKey(fromJson: localeFromString, toJson: localeToString)  Locale? locale, @JsonKey(fromJson: UiBrightness.fromJson, toJson: UiBrightness.toJson)  UiBrightness brightness,  bool use24HourFormat)?  $default,) {final _that = this;
switch (_that) {
case _AppSettingsModel() when $default != null:
return $default(_that.locale,_that.brightness,_that.use24HourFormat);case _:
  return null;
...
class _AppSettingsModel extends AppSettingsModel {
  const _AppSettingsModel({@JsonKey(fromJson: localeFromString, toJson: localeToString) this.locale, @JsonKey(fromJson: UiBrightness.fromJson, toJson: UiBrightness.toJson) this.brightness = UiBrightness.system, this.use24HourFormat = true}): super._();
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _AppSettingsModel&&(identical(other.locale, locale) || other.locale == locale)&&(identical(other.brightness, brightness) || other.brightness == brightness)&&(identical(other.use24HourFormat, use24HourFormat) || other.use24HourFormat == use24HourFormat));
}
...
/// Create a copy of AppSettingsModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? locale = freezed,Object? brightness = null,Object? use24HourFormat = null,}) {
