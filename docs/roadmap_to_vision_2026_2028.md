...
| Milestone                               | Deliverables                                                                                                                                                                                                                                       | Success                                                                       |
| --------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------- |
| **1.5.1 Commitment + PlannedSum model** | New data model: commitments (recurring obligations) + planned sums; migration from manual budgets; transactions demote to reconciliation evidence.                                                                                                 | Daily number computed from the single model; two-budget-systems debt retired. |
| **1.5.2 Sum→Reason UX**                 | Drift prompt: adjust remaining planned sum in one action, or log records to explain delta.                                                                                                                                                         | Reconciliation never gates the number; ≤2 taps to any depth.                  |
